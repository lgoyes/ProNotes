...
import com.lamadridblandongoyes.pronotes.labeledition.LabelEditionModule
...
abstract class ActivityBuilder {
    ...
    @ContributesAndroidInjector(modules = [(LabelEditionModule::class)])
    abstract fun bindLabelEditionActivity(): LabelEditionActivity
